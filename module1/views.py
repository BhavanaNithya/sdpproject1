...
def print_to_console(request):
    if request.method == "POST":
        ...
        '''gets the data from the user the above tow lines'''
...
'''a1 is the local variable so no need to change the variable.'''
...
def weatherlogic(request):
    if request.method == 'POST':
        ...
        API_KEY = '30fcd86314a4383a7b91107f567ceed5'
